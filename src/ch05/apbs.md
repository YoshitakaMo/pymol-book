...
<img src="./image/apbs1.png" title="APBSの表示例" alt="APBSの表示例">
...
<img src="./image/apbsmenu1.png" width="300px" title="APBSmenu1" alt="APBSmenu1">

中のメニューはこうなっています。

<img src="./image/apbsmenu2.png" width="300px" title="APBSmenu2" alt="APBSmenu2">
...
<img src="./image/apbsmenu6.png" title="APBSmenu6" alt="APBSmenu6">

正常にAPBSの計算が終わると、Close the APBS dialog?と問われます。閉じてもOKです。

<img src="./image/apbsmenu7.png" title="APBSmenu7" alt="APBSmenu7">

計算が終わると、このように3x2oの表面が赤・白・青に分けて表示されるようになりました。

<img src="./image/apbs4.png" title="APBS4" alt="APBS4">
...
<img src="./image/apbs5.png" width="300px" title="APBS5" alt="APBS5">
...
<img src="./image/apbsmenu3.png" title="APBSmenu3" alt="APBSmenu3">
...
<img src="./image/apbsmenu4.png" title="APBSmenu4" alt="APBSmenu4">
...
<img src="./image/apbsmenu5.png" title="APBSmenu5" alt="APBSmenu5">
...
<img src="./image/apbs8.png" title="Homebrew APBS" alt="Homebrew APBS">
...
cp -rp ~/pymolplugin/* ${HOMEBREW_PREFIX}/opt/pymol/libexec/lib/python3.14/site-packages/pmg_tk/startup
...
<img src="./image/apbsmenu1.png" title="APBSmenu1" alt="APBSmenu1">

この文字をクリックし、Advanced Configurationのタブをクリックします。このProgram Locationsを自身の環境にあわせて設定する必要があります。

<img src="./image/apbs3.png" title="APBSの表示例" alt="APBSの表示例">
